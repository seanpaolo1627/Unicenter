	...
	<div class="container mt-4">
		<div class="card mb-5">
			...
			<div class="card-body">
				...
				<div class="mb-3">
					<button type="button" @click="updateAssignment" class="btn btn-primary">Update</button>
...
<script>
	...
	export default {
		...
		mounted() {
			console.log('Mounted - EditAssignment component');
		...
		methods: {
			...
			getAssignmentDetails() {
				...
				axios.get(`http://localhost:8000/api/assign_designations/${assignmentId}`)
				.then(res => {
					this.model = res.data.assign;
					this.updateDepartment();
				})
				.catch(error => {
			...
			updateAssignment() {
				const assignmentId = this.$route.params.id;
				axios.put(`http://localhost:8000/api/assign_designations/${assignmentId}/edit`, this.model)
				.then(res => {
